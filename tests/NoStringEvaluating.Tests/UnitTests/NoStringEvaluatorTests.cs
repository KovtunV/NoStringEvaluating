...
namespace NoStringEvaluating.Tests.UnitTests;
...
internal class NoStringEvaluatorTests
{
    ...
    public void Should_Evaluate_Number(Models.FormulaModel model)
    {
        // arrange, act
    ...
    public void Should_Evaluate_Word(Models.FormulaModel model)
    {
        // arrange, act
    ...
    public void Should_Evaluate_DateTime(Models.FormulaModel model)
    {
        // arrange, act
    ...
    public void Should_Evaluate_WordList(Models.FormulaModel model)
    {
        // arrange, act
    ...
    public void Should_Evaluate_NumberList(Models.FormulaModel model)
    {
        // arrange, act
    ...
    public void Should_Evaluate_Boolean(Models.FormulaModel model)
    {
        // arrange, act
